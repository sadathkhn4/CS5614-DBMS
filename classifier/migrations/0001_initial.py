# Generated by Django 3.2 on 2023-11-21 19:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Map',
            fields=[
                ('id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='classifier.image')),
                ...
                ('image_path', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maps_path', to='classifier.image')),
            ],
        ),
    ]
